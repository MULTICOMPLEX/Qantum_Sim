...
#Ψ, psi0 = ITE(Ψ, [psi1, psi2], js["store steps"], Nt_per_store_step, Ur, Uk)
def ITE(Ψ, psi1, store_steps, Nt_per_store_step, Ur, Uk):
...
Ψ, psi2 = ITE(Ψ, [psi1], js["store steps"], Nt_per_store_step, Ur, Uk)
print("Took", time.time() - t0)

t0 = time.time()
Ψ, psi3 = ITE(Ψ, [psi1, psi2], js["store steps"], Nt_per_store_step, Ur, Uk)
print("Took", time.time() - t0)

t0 = time.time()
Ψ, psi4 = ITE(Ψ, [psi1, psi2, psi3], js["store steps"], Nt_per_store_step, Ur, Uk)
print("Took", time.time() - t0)

t0 = time.time()
Ψ, psi5 = ITE(Ψ, [psi1, psi2, psi3, psi4], js["store steps"], Nt_per_store_step, Ur, Uk)
print("Took", time.time() - t0)

t0 = time.time()
Ψ, psi6 = ITE(Ψ, [psi1, psi2, psi3, psi4, psi5], js["store steps"], Nt_per_store_step, Ur, Uk)
print("Took", time.time() - t0)
